...
$_['text_activity_affiliate_add']  = '<a href="customer_id=%d">%s</a> - зарегистрирован новый аккаунт.';
$_['text_activity_affiliate_edit'] = '<a href="customer_id=%d">%s</a> - обновлена информация аккаунта.';
